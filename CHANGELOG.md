...
- Curated seed rules now include 82 more active high-confidence merchants from the existing catalog input, bringing `seed_rules.json` from 551 to 633 rules with asset tests for category validity, duplicate patterns, and the R-05 batches.
