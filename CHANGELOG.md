...
- Curated seed rules now include 106 more active high-confidence merchants from catalog and aggregate-only private-audit review, bringing `seed_rules.json` from 551 to 657 rules with asset tests for category validity, duplicate patterns, and the R-05 batches.
