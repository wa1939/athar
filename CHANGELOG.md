...
- Curated seed rules now include 67 more active high-confidence merchants from the existing catalog input, bringing `seed_rules.json` from 551 to 618 rules with an asset test for category validity, duplicate patterns, and the R-05 batch.
