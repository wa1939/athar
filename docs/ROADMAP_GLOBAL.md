...
**Status:** Store-safe listener is wired, generic parsing works, and the first app-specific phrase/package follow-up has shipped; more bank-specific handlers remain.
...
| 3 | G-11 bank-specific notification handlers follow-up | 2–3 days | First app-handler batch shipped; continue with more real Wise/Revolut/Chase/Capital One/Mercury notification copy |
