...
**Status:** Store-safe listener is wired and now has a generic bank-app notification parser; app-specific handlers remain.
...
| 3 | G-11 app-specific notification handlers | 3 days | Broaden Play-Store-safe ingestion for Wise, Revolut, Chase, Capital One, Mercury, Apple/Google Wallet, etc. |
