...
- TMOAP Budget Targets, Wishlist rows, and Family Investments rows are handled
  by separate Settings import cards. Statement import stays transaction-only and
  never changes Plan data as a side effect.
