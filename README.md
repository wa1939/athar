...
- ✅ **Private-corpus parser cleanup** — Arabic card settlements, salary/cashback, D360 own-account transfers, public-service payments, and account/card admin notices are routed or ignored correctly; a local aggregate audit now leaves only 20 parsed expense rows with missing merchants
...
- ✅ Rule engine with **657 merchant seed rules** across 22 categories (beta.17+R-05 — expanded from 44 curated rules with AI-categorized patterns plus reviewed priority-90 catalog/private-audit batches; rules auto-refresh on app upgrade)
