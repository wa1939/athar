...
- ✅ **Private-corpus parser cleanup** — Arabic card settlements, salary/cashback, D360 own-account transfers, public-service payments, account/card admin notices, account-tail purchase labels, ATM withdrawals, bank-fee debits, and wallet refunds are routed, ignored, or labeled correctly; a local received-message audit now leaves only 5 parsed expense rows with missing merchants
...
- ✅ Rule engine with **705 merchant seed rules** across 22 categories (beta.17+R-05 — expanded from 44 curated rules with AI-categorized patterns plus reviewed priority-90 catalog/private-audit/public-common batches; rules auto-refresh on app upgrade)
