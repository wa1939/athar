...
- ✅ Rule engine with **712 merchant seed rules** across 22 categories (beta.17+R-05+G-11 — expanded from 44 curated rules with AI-categorized patterns plus reviewed priority-90 catalog/private-audit/public-common batches and exact recurring-expense notification labels; rules auto-refresh on app upgrade)
