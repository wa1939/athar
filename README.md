...
- ⏳ Device E2E, screenshot UI audit, and notification tap-through still need a physical Android device or a working accelerated emulator. On 2026-06-14 `AtharPixelQaApi35` emitted software-boot logs but exited before exposing ADB, and `AtharPixelQaApi35Arm` exited because arm64 system images are not supported by this x86_64 host, preventing install, launch, screenshots, and tap-through.
