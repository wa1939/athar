...
- ✅ Rule engine with **713 merchant seed rules** across 22 categories (beta.17+R-05+G-11 — expanded from 44 curated rules with AI-categorized patterns plus reviewed priority-90 catalog/private-audit/public-common batches and exact notification labels for recurring expenses and telecom recharge; rules auto-refresh on app upgrade)
